...
var token = '66C095912444ABF360DF63CE16B29F51';
var app = express();
...
/**
 * GET /api/getReleasingMovies 
 * Returns Movies Released this week
 * https://api.cinemalytics.com/v1/movie/upcoming?auth_token=66C095912444ABF360DF63CE16B29F51
 */

app.get('/api/getReleasingMovies',function(req,res,next){
    
    var getMoviesURL = 'https://api.cinemalytics.com/v1/movie/upcoming?auth_token=' + token;
    request.get(getMoviesURL, function(error, response, data) {
...
/**
 * GET /api/getMoviesThisYear
 * Returns Movies Released this week
 * https://api.cinemalytics.com/v1/movie/year/2001/?auth_token=66C095912444ABF360DF63CE16B29F51
 */
app.get('/api/getMoviesThisYear',function(req,res,next){
    
    var getMoviesURL = 'https://api.cinemalytics.com/v1/movie/year/2016?auth_token=' + token;
    request.get(getMoviesURL, function(error, response, data) {
        if (error) return next(err);
        if(!error && response.statusCode == 200) {
            return res.send(data);
