...
var HomeActions = function () {
  function HomeActions() {
    ...
    this.generateActions('getReleasingMoviesSuccess', 'getReleasingMoviesFail', 'getMoviesThisYearSuccess', 'getMoviesThisYearFail');
  }

  _createClass(HomeActions, [{
    key: 'getReleasingMovies',
    value: function getReleasingMovies() {
      var _this = this;

      $.ajax({ url: '/api/getReleasingMovies' }).done(function (data) {
        _this.actions.getReleasingMoviesSuccess(data);
      }).fail(function (jqXhr) {
        _this.actions.getReleasingMoviesFail(jqXhr.responseJSON.message);
      });
    }
  }, {
    key: 'getMoviesThisYear',
    value: function getMoviesThisYear() {
      var _this2 = this;

      $.ajax({ url: '/api/getMoviesThisYear' }).done(function (data) {
        _this2.actions.getMoviesThisYearSuccess(data);
      }).fail(function (jqXhr) {
        _this2.actions.getMoviesThisYearFail(jqXhr.responseJSON.message);
      });
    }
  }]);
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'a',
                  { href: 'https://github.com/saidheerajg' },
                  'Source Code'
                ),
...
var Home = function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function componentDidMount() {
      ...
      _HomeActions2.default.getReleasingMovies();
    ...
    value: function render() {
      ...
      var movieNodes = this.state.movies.map(function (movie, index) {
        return _react2.default.createElement(
          'div',
          { key: movie.Id, className: index % 4 === 0 ? 'col-xs-3 col-sm-3 col-md-3' : 'col-xs-3 col-sm-3 col-md-3' },
          _react2.default.createElement(
            'div',
            { className: 'thumbnail fadeInUp animated' },
            _react2.default.createElement('img', { onClick: _this2.handleClick.bind(_this2, movie), src: movie.PosterPath }),
            _react2.default.createElement(
              'div',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          'Click on a movie. Select your favorite.'
        ),
        _react2.default.createElement(
          'div',
          { className: 'row' },
...
var HomeStore = function () {
  ...
  _createClass(HomeStore, [{
    key: 'onGetMoviesThisYearSuccess',
    value: function onGetMoviesThisYearSuccess(data) {
      this.movies = JSON.parse(data);
    }
  }, {
    key: 'onGetMoviesThisYearSuccess',
    value: function onGetMoviesThisYearSuccess(errorMessage) {
      toastr.error(errorMessage);
    }
  }, {
    key: 'onGetReleasingMoviesSuccess',
    value: function onGetReleasingMoviesSuccess(data) {
      this.movies = JSON.parse(data);
    }
  }, {
    key: 'onGetReleasingMoviesFail',
    value: function onGetReleasingMoviesFail(errorMessage) {
      toastr.error(errorMessage);
    }
  }]);
